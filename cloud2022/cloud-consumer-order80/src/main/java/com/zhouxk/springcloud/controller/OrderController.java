...
public class OrderController {
    ...
    public CommonResult<Payment> create(@RequestBody Payment payment) {
        return restTemplate.postForObject(PAYMENT_URL + "/payment8001/create", payment, CommonResult.class);
    }

    @GetMapping("/payment/get/{id}")
    public CommonResult<Payment> getPayment(@PathVariable("id") Long id) {
        return restTemplate.getForObject(PAYMENT_URL + "/payment8001/get/" + id, CommonResult.class);
    }
    ...
    public CommonResult queryAllByLimit(@RequestParam(defaultValue = "0") int offset,
        ...
        return restTemplate.getForObject(
                PAYMENT_URL + "/payment8001/queryAllByLimit?offset=" + offset + "&limit=" + limit, CommonResult.class);
    }

    @GetMapping("/payment/getForEntity/{id}")
    public CommonResult<Payment> getPayment2(@PathVariable("id") Long id) {
        ResponseEntity<CommonResult> entity = restTemplate.getForEntity(PAYMENT_URL + "/payment8001/get/" + id, CommonResult.class);
